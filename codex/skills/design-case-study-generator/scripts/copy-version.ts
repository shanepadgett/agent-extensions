...
function usageAndExit(message?: string): never {
  ...
  console.error(
    [
      'Usage:',
      '  bun run codex/skills/design-case-study-generator/scripts/copy-version.ts -- --slug <series-slug> [--runsDir design-system/runs] [--from vN] [--to vN]',
      '',
      'Examples:',
      '  bun run codex/skills/design-case-study-generator/scripts/copy-version.ts -- --slug landing-page-bold-noir --from v1',
      '  bun run codex/skills/design-case-study-generator/scripts/copy-version.ts -- --slug landing-page-bold-noir --from v2 --to v3',
    ].join('\n'),
  );
