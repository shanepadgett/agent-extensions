...
function usage() {
  return [
    "Usage:",
    "  node skills/spec-format/scripts/validate-change-spec.mjs <change-spec-path>",
    "",
    "Examples:",
    "  node skills/spec-format/scripts/validate-change-spec.mjs changes/auth-refresh/specs/auth/login.md",
  ].join("\n");
}
